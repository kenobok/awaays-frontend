...
const HowItWorks = () => {
    ...
    return (
        <section ref={ howItWorksRef } id="howitworks" className="overflow-hidden">
            <motion.div className="how-it-works flex justify-around max-[768px]:flex-col items-center gap-x-7 p-10 max-[768px]:px-5 bg-gray-200 my-5 overflow-hidden rounded-4xl" initial={{ opacity: 0, y: 200 }}  whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false }} transition={{ duration: 1 }}>
                ...
                <div className="flex-1 relative pt-10">
                    ...
                    <div className="hiwis relative grid grid-cols-4 max-[1081px]:grid-cols-2 max-[506px]:grid-cols-1 gap-x-6 max-[506px]:gap-x-0 bg-[var(--bg-color)] w-[100%] rounded-4xl p-3 overflow-hidden">
                        <div className="hiwi-outer p-1">
                            <div className="hiwi bg-gray-200"><FontAwesomeIcon icon="user-plus"/></div>
                            <h4>Join | Login</h4>
                        ...
                        <div className="hiwi-outer max-[506px]:flex flex-col  p-1">
                            ...
                            <div className="hiwi bg-gray-200 order-1"><FontAwesomeIcon icon="hand-holding"/> <FontAwesomeIcon icon="gifts" className="absolute text-[1.7rem] top-[2.5rem]"/></div>
                        </div>
                        <div className="hiwi-outer p-1">
                            <div className="hiwi bg-gray-200"><FontAwesomeIcon icon="hands-holding"/> <FontAwesomeIcon icon="box" className="absolute text-[1.7rem] top-[2.2rem]"/></div>
                            <h4>Collecting</h4>
                        ...
                        <div className="hiwi-outer p-1 max-[506px]:flex flex-col">
                            ...
                            <div className="hiwi bg-gray-200 order-1"><FontAwesomeIcon icon="users"/></div>
                        </div>
                    </div>
                </div>
            </motion.div>
