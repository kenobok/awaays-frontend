    ...
    return (
        <div className="relative max-w-[1600px] mx-auto">
            <div className="relative w-full">
                <motion.aside className="space-y-5 fixed top-[6rem] ml-2 max-[941px]:top-[7rem] left-0 min-[1600px]:left-[calc((100vw-1600px)/2)] h-[90vh] max-[941px]:h-[78vh] w-[17rem] bg-[var(--bg-color)] p-5 rounded-lg border border-gray-300 overflow-y-auto z-2" initial={{opacity: 0, x: -500}} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1.5, ease: 'easeInOut' }}>
