...
const SuggestionsAndFeedbacks = () => {
    ...
    return (
        <div className='ml-25 max-[768px]:ml-0'>
            <h3 className='text-center text-[1.3rem] font-semibold mb-5 border-b border-gray-200'>Suggestions & Feedbacks</h3>
            <div className='py-10'>
...
export default SuggestionsAndFeedbacks
