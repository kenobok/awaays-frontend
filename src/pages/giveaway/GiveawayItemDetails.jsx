...
const GiveawayItemDetails = () => {
    ...
    const { data, error, isLoading } = useGiveawayItemDetails(slug);
                ...
                <section className="flex-1">
                    <motion.div className="flex-1 modal-text overflow-auto pl-10 py-3 max-[768px]:pl-0 m-auto" initial={{ opacity: 0, x: 300 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1, ease: "easeInOut" }} >
                        ...
                        <div className="relative my-5">
                            <p className="absolute border border-green-500 text-green-600 shadow-lg py-[3px] px-7 rounded-s-3xl top-0 right-0" style={{borderRight:'0'}}><b>Donor - </b>{data.donor}</p>
                        </div>
